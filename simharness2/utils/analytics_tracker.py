...
class AnalyticsTracker(BaseAnalyticsTracker):
    ...
    def __init__(self, sim_area, agent_speed, num_agents = 1):
        ...
        self.benchsim_tracker = SimulationMetricsTracker(sim_area, agent_speed, num_agents)



    #run this update function after every action the agent takes
    def update_after_one_agent_step(self, timestep, agent_pos: List[int], fire_map: np.ndarray, interaction: bool):

        self.timestep = timestep

        self.sim_tracker.agent_tracker.update(self.timestep, agent_pos, fire_map, interaction)
        
    


    #run this update function after every sim_step within an episode within a simulation
    def update_after_one_simulation_step(self, timestep, fire_map: np.ndarray, sim_active: bool, bench_fire_map: np.ndarray, benchsim_active: bool):
...
class SimulationMetricsTracker:
    ...
    def update(self, timestep, fire_map: np.ndarray, sim_active: bool):
        ...
        num_undamaged_tmp = self.sim_area - self.burned - self.burning - self.num_mitigations
...
class AgentMetricsTracker:
    ...
    def update(self, timestep, agent_pos: List[int], fire_map: np.ndarray, interaction: bool):
