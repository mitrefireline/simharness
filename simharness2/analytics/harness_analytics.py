...
from simharness2.analytics.utils import BestEpisodePerformance
        ...
        *,
        ...
        try:
            ...
            if benchmark_sim:
                ...
                self.benchmark_sim_analytics = None
        ...
        *,
        ...
        Arguments:
            sim: The underlying `FireSimulation` object that contains the agent (s) that
                ...
                finished spreading.
            sim_analytics_partial: A `functools.partial` object that defines the class that will
                ...
                `agent_analytics_partial` keyword argument, along with a valid value.
        ...
        if terminated:
            ...
            if update_best_episode_performance:
                self.best_episode_performance = BestEpisodePerformance(
                    ...
                    sim_area=self.sim_analytics._sim.fire_map.size,
