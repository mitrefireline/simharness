"""
Sample rl_harness.py env for simharness 2.0 with benchmark sim and integrated Reward Class that inherits FEAR data extraction and dual (Benchmark + Agent) simulation capabilites
...
class RLHarness(gym.Env, ABC):
    ...
    def __init__(
        ...
        #--------------------------------------------------------------------------------------------
        #NEW: run parallel benchmark simulation that recieves no mitigations
        ##(dgandikota)
