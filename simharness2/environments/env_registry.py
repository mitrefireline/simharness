...
def marl_reactive_discrete_env_creator(env_config: Dict[str, Any]) -> RLHarness:
    """Environment creator for RLlib.
    ...
    Returns:
        An instance of the MARLReactiveDiscreteHarness (environment) class.
    """
    register(
        id="MARLReactiveHarness-v0",
        entry_point="simharness2.environments.reactive_marl:MARLReactiveDiscreteHarness",
        max_episode_steps=2000,  # TODO make this a configurable parameter
    )
    return MARLReactiveDiscreteHarness(**env_config)
...
register_env(name="MARLReactiveHarness-v0", env_creator=marl_reactive_discrete_env_creator)
